...
| 5 | SEO / images / metadata | ✅ завършено (metadata, sitemap.xml, robots.txt) |
| 6 | Почистване, build, деплой | ✅ завършено (Vite файлове изтрити, финален build минава) |

> Последна актуализация: 2026-06-02 — МИГРАЦИЯТА Е ЗАВЪРШЕНА, branch: feat/nextjs
> Остава: npm start тест + визуална проверка → merge в main → Vercel env vars
